...
class HandleCors extends Middleware
{
    ...
    public function handle(Input $input): MiddlewareResponse
    {
        ...
        if (!$this->shouldRun($input)) return parent::handle($input);
        ...
        if ($cors->isPreflightRequest($input)) {
            ...
            $this->setTitle("Preflight Request");
            $this->setResponse("This is a preflight request response.");
            $this->setResponseCode(HTTP::NO_CONTENT);
            return $this;
        }
