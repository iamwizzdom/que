...
class Server implements  ArrayAccess, Countable, JsonSerializable, IteratorAggregate, Serializable
{
    /**
     * @var Server
     */
     ...
     * @return $this
     */
    public function add(string $offset, $data): Server {
