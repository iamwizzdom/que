...
class PHPMailer
{
    ...
    /**
     * RuntimeError severity: message only, continue processing.
     *
     * @var int
     */
    ...
    /**
     * RuntimeError severity: message, likely ok to continue processing.
     *
     * @var int
     */
    ...
    /**
     * RuntimeError severity: message, plus full stop, critical error reached.
     *
     * @var int
     */
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            'authenticate' => 'SMTP RuntimeError: Could not authenticate.',
            'connect_host' => 'SMTP RuntimeError: Could not connect to SMTP host.',
            'data_not_accepted' => 'SMTP RuntimeError: data not accepted.',
            'empty_message' => 'Message body empty',
            'encoding' => 'Unknown encoding: ',
            'execute' => 'Could not execute: ',
            'file_access' => 'Could not access file: ',
            'file_open' => 'File RuntimeError: Could not open file: ',
            'from_failed' => 'The following From address failed: ',
            'instantiate' => 'Could not instantiate mail function.',
            'invalid_address' => 'Invalid address: ',
            'mailer_not_supported' => ' mailer is not supported.',
            'provide_address' => 'You must provide at least one recipient email address.',
            'recipients_failed' => 'SMTP RuntimeError: The following recipients failed: ',
            'signing' => 'Signing RuntimeError: ',
