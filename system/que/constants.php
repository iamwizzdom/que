 ...
 * function constants
 */
const FILTER_GET_EMAIL_NAME = 0;
const FILTER_GET_EMAIL_HOST = 1;
...
const HTTP_FORBIDDEN_METHOD_CODE = 405;
const HTTP_REQUEST_TIMEOUT_CODE = 408;
const HTTP_CONFLICT_CODE = 409;
const HTTP_LARGE_PAYLOAD_CODE = 413;
const HTTP_EXPECTATION_FAILED_CODE = 417;
const HTTP_EXPIRED_AUTH_CODE = 419;
const HTTP_MAINTENANCE_CODE = 420;
...
const HTTP_UNSUPPORTED_VERSION_CODE = 505;
 ...
 */
const DEFAULT_PAGINATION_RECORD_PER_PAGE = 20;
